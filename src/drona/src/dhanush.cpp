 ...
 * In practice, it is rare since the signal is emmitted at 100 Hz and this function should finish much faster
 * This is so dumb, a thread should be launched for performing heavy tasks. This light ahh function should not need a separate thread!!
