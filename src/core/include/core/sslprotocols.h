...
/*
 * SSL simulator will publish error messages on this port
 * address will by default be localhost for now
 */
constexpr const uint16_t SSL_SIMULATED_ERROR_PORT = 103462;
